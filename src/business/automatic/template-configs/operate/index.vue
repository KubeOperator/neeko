      ...
      <el-col :span="10">
        <div class="grid-content bg-purple-light">
          <el-form ref="form" :model="form" :rules="rules" label-width="200px" label-position="left">
            ...
            <el-form-item :label="$t('automatic.template_config.qcow2_path')" prop="config.qcow2_path" v-if="form.type === 'OpenStack'">
              <el-input v-model="form.config.qcow2_path"></el-input>
            </el-form-item>
            <el-form-item :label="$t('automatic.template_config.vmdk_path')" prop="config.vmdk_path" v-if="form.type === 'vSphere'">
              <el-input v-model="form.config.vmdk_path"></el-input>
            </el-form-item>
            <el-form-item :label="$t('automatic.template_config.ovf_path')" prop="config.ovf_path" v-if="form.type === 'vSphere'">
