  ...
  <el-tabs  tab-position="left" style="height: 450px">
    <el-tab-pane :label="$t('setting.table.message.wechat')">
      <el-form ref="form" :model="form" label-width="140px">
        ...
        <el-form-item  style="width: 50%" label="secret" required>
          <el-input type="password" v-model="form.vars['WORK_WEIXIN_CORP_SECRET']"></el-input>
        </el-form-item>
    ...
    <el-tab-pane :label="$t('setting.table.message.dingTalk')">
      <el-form ref="form" :model="form" label-width="140px">
        ...
        <el-form-item  style="width: 50%" label="secret" required>
          <el-input type="password" v-model="form.vars['DING_TALK_SECRET']"></el-input>
        </el-form-item>
        <el-form-item  style="width: 50%" :label="$t('setting.table.message.testUser')" required>
...
<script>
import {checkMessage, createMessageSetting, createMessage, getMessageSetting} from "@/api/system-setting";
...
export default {
  ...
  computed: {
    ...
    btnSelectDk(){
      let status = this.form.vars['DING_TALK']
      if (status == "ENABLE"){
        return false
      }else {
        return true
