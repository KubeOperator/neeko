  ...
  export default {
    ...
    data() {
      return {
        buttons: [
          {
            label: this.$t('commons.button.upgrade'), icon: "el-icon-video-play", click: this.upgrade
          }, {
            label: this.$t('commons.button.check'), icon: "el-icon-delete", type: "danger", click: this.check
          },
        ],
        paginationConfig: {
          currentPage: 1,
