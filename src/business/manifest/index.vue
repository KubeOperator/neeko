          ...
          <el-col :span="6">
            <el-card style="margin-left:10px; margin-top:10px" class="box-card">
              ...
              <el-col :span="20">
                ...
                <el-switch style="margin-bottom: 10px; float: right" :active-text="$t('manifest.enable')" @change="changeEnable(versionMini)" v-model="versionMini.isActive" active-color="#13ce66" inactive-color="#818181"></el-switch>
              </el-col>
            </el-card>
          </el-col>
        </div>
