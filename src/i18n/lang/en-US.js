...
const message = {
  ...
  cluster: {
    ...
    creation: {
      ...
      network_interface_help: "Multiple network card environment needs to specify the name of the network card to be used, single network card environment is not filled",
